...
HEADER = ['id_review', 'caption', 'more_caption', 'type_vocation', 'Travel group', 'Hotel highlights', 'relative_date', 'retrieval_date', 'rating', 'username', 'n_review_user', 'n_photo_user', 'url_user']
